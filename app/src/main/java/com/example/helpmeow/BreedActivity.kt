...
class BreedActivity: Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val breedGridView: GridView = findViewById(R.id.storyRecyclerView)
    ...
    private fun getBreedData(): List<BreedItem> {
        val breedList: MutableList<BreedItem> = mutableListOf()
        breedList.add(
            BreedItem(
                R.drawable.breed1,
                "Abyssinian",
